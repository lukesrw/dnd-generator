...
const TRAITS = [
    ...
    {
        value: "I quote (or misquote) the sacred texts and proverbs in almost every situation"
    },
    {
    ...
    {
        value: "I pocket anything I see that might have some name"
    },
    {
        value: "I always have plan for what to do when things go wrong"
    },
    {
    ...
    {
        value: "Nobody stays angry at me or around me for long, since I can defuse any amount of tension"
    },
    {
    ...
    {
        value: "If someone is in trouble, I'm always willing to lend help"
    },
    {
    ...
    {
        value: "I believe that everything worth doing is worth doing right. I can't help it--I'm a perfectionist"
    },
    {
    ...
    {
        value: "The leader of my community has something wise to say on every topic, and I am eager to share that wisdom"
    },
    {
    ...
    {
        value: "I often get lost in my own thoughts and contemplations, becoming oblivious to my surroundings"
    },
    {
    ...
    {
        value: "Despite my birth, I do not place myself above other folk. We all have the same blood"
    },
    {
    ...
    {
        value: "I once ran twenty-five miles without stopping to warn my clan of an approaching orc horde. I'd do it again if I had to"
    },
    {
    ...
    {
        value: "I use polysyllabic words to convey the impression of great erudition"
    },
    {
        value: "I've read every book in the world's greatest libraries--or like to boast that I have"
    },
    {
    ...
    {
        value: "I can stare down a hellhound without flinching"
    },
    {
    ...
    {
        value: "I bluntly say what other people are hinting or hiding"
    }
] as const;

export type Trait = (typeof TRAITS)[number]["value"];

export namespace Trait {
    export const List = _List.createList(TRAITS);
}
